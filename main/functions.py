...
def sendSMS(message_type, numbers, variables_values=[]):
    ...
    if is_ok:
        url = f"https://www.fast2sms.com/dev/bulkV2?authorization={key}&route=dlt&sender_id=Abdulrasool&message={message_id}&variables_values={values}&flash=0&numbers={numbers}"
...
# def send_email(subject,to_address,content,bcc_address=settings.DEFAULT_BCC_EMAIL,app="Abdulrasool",reply_to_address=settings.DEFAULT_REPLY_TO_EMAIL,attachment=None):
#     print("send fun")
